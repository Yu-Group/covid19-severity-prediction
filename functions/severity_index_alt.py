...
def write_to_gsheets(df, ks_output=['Severity 1-day', 'Severity 2-day', 'Severity 3-day', 'Predicted Deaths Hospital 1-day', 'Hospital Name',
                                    'CMS Certification Number', 'countyFIPS', 'CountyName', 'StateName', 'System Affiliation'],
                     sheet_name='COVID Severity Index 04/02',
...
if __name__ == '__main__':
    ...
    df = df[df.StateNameAbbreviation.isin(['IL', 'IN', 'LA', 'MI', 'GA', 'CA', 'WA', 'FL'])]    
    write_to_gsheets(df)
    print('success!')
