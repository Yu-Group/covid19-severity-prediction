...
def add_severity_index(df, NUM_DAYS_LIST=[1, 2, 3]):
    ...
    for num_days in NUM_DAYS_LIST:
        ...
        df[f'Rural Severity {num_days}-day'][idxs_rural] = percentiles_with_manual_low(df[f'Predicted Deaths Hospital {num_days}-day'][idxs_rural]) 
...
def write_to_gsheets(d, sheet_name='COVID Severity Index',
                     service_file='../creds.json'):
    '''Write hospital data to google sheet
    '''
...
if __name__ == '__main__':
    ...
    write_to_gsheets(df[ks_output], service_file=oj(parentdir, 'creds.json'))
